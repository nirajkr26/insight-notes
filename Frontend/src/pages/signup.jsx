                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="p-6 pt-0 space-y-4 flex flex-col">
                            <div className="space-y-2 flex flex-col">
                                ...
                                <input value={formData.name} onChange={handleChange} type="text" name="name" id="name" placeholder="Enter your name" className="px-3 py-2 rounded-lg focus-visible:border-3 text-sm h-12 bg-gray-900 focus-visible:outline-none" required />
                            </div>
                            <div className="space-y-2 flex flex-col">
                                <label htmlFor="email" className="font-semibold tracking-tight px-3">Email</label>
                                <input value={formData.email} onChange={handleChange} type="text" name="email" id="email" placeholder="Enter your email" className="px-3 py-2 rounded-lg focus-visible:border-3 text-sm h-12 bg-gray-900 focus-visible:outline-none" required />
                            </div>
                            <div className="space-y-2 flex flex-col">
                                <label htmlFor="password" className="font-semibold tracking-tight px-3">Password</label>
                                <input value={formData.password} onChange={handleChange} type="password" name="password" id="password" placeholder="Enter your password" className="px-3 py-2 rounded-lg focus-visible:border-3 text-sm h-12 bg-gray-900 focus-visible:outline-none" required />
                            </div>
                        </div>
                        <div className="items-center p-6 pt-0 flex flex-col space-y-4">
                            <button className="flex justify-center items-center bg-white text-black w-full py-2 rounded-lg font-bold tracking-tight cursor-pointer hover:bg-gray-200" type='submit'>Create Account</button>
                            <SignedOut>
                                <SignInButton forceRedirectUrl={"/dashboard"} className="flex justify-center items-center gap-1 bg-white text-black w-full py-2 rounded-lg font-bold tracking-tight cursor-pointer hover:bg-gray-200" >
